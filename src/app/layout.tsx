...
export const metadata: Metadata = {
  title: {
    default: "Tales of the Shire Guide - Hobbit Life Companion",
    template: "%s | Tales of the Shire Guide"
  },
  description: "Your ultimate companion for The Lord of the Rings: Tales of the Shire game. Discover authentic hobbit recipes, meet beloved characters, and create perfect decorations.",
  keywords: [
    "Tales of the Shire",
    "Hobbit Guide", 
    "Middle-earth",
  ...
  openGraph: {
    ...
    title: "Tales of the Shire Guide - Hobbit Life Companion",
    description: "Your ultimate companion for The Lord of the Rings: Tales of the Shire game. Discover authentic hobbit recipes, meet beloved characters, and create perfect decorations.",
